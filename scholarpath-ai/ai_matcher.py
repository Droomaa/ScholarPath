...
class ScholarPathMatcher:
    def __init__(self, dataset_path):
        ...
        self.df['search_content'] = (
            ...
            self.df['scholarship_path'].astype(str) + " " +  # <-- Ini kunci utamanya (Engineering/STEM)
...
# Ubah bagian fungsi search menjadi seperti ini: top_k bisa diatur untuk menampilkan berapa data yang muncul
...
if __name__ == "__main__":
    ...
    # AI akan otomatis membuang hasil di bawah 40%
    ...
    rekomendasi_beasiswa = matcher.search(
        ...
        alpha=0.7, 
        # top_k bisa diatur untuk menampilkan berapa data yang muncul
        top_k=3, 
